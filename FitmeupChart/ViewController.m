...
- (void)initChart
{
    ...
    [pt1 setPointLabelText:[dateFormatter stringFromDate:[NSDate dateWithTimeIntervalSinceNow:-3 * SECS_PER_DAY]]];
    ...
    [pt5 setPointLabelText:[dateFormatter stringFromDate:[NSDate dateWithTimeIntervalSinceNow:1 * SECS_PER_DAY]]];
    ...
    [pt7 setPointLabelText:[dateFormatter stringFromDate:[NSDate dateWithTimeIntervalSinceNow:3 * SECS_PER_DAY]]];
    ...
    [dataSet setPlotColor:[UIColor greenColor]];
    ...
    [pt11 setPointLabelText:[dateFormatter stringFromDate:[NSDate dateWithTimeIntervalSinceNow:-5 * SECS_PER_DAY]]];
    ...
    [pt17 setPointLabelText:[dateFormatter stringFromDate:[NSDate dateWithTimeIntervalSinceNow:5 * SECS_PER_DAY]]];
    ...
    [dataSet1 setPlotColor:[UIColor redColor]];
