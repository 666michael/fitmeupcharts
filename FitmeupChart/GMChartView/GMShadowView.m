...
- (void)drawRect:(CGRect)rect
{
    ...
    CGContextSetStrokeColorWithColor(context, [UIColor gm_redColor].CGColor);
    CGContextSetFillColorWithColor(context, [UIColor gm_redColor].CGColor);
